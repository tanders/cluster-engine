# -*- eval: (org-sbe "setup-elisp")  eval: (org-sbe "setup-lisp") -*-
...
* Setup                         :noexport:
  ...
  Execute code-block =setup= when loading this file. Called by first
  line of this buffer.
  See
  https://www.gnu.org/software/emacs/manual/html_node/emacs/Specifying-File-Variables.html#Specifying-File-Variables
  and https://emacs.stackexchange.com/questions/29816/org-mode-comment-blocks-local-variable-eval.


#+name: setup-elisp
#+begin_src emacs-lisp :results silent :exports none
  ;; (defun ta/publish-sphinx-project (PLIST SCRIPT PUB-DIR)
  ;;   (call-process SCRIPT))

  (setq org-publish-project-alist
	'(
	  ;; ("cluster-engine-doc-expand-orgfiles"
	  ;;  :base-directory "." ;; relative path
	  ;;  :base-extension "org"
	  ;;  :publishing-directory "../doc_source_orgmode_expanded"
	  ...
	  ;;  :with-toc nil
	  ;;  ) 
	  ;; ("cluster-engine-doc-sphinx-orgfiles"
	  ;;  :base-directory "../doc_source_orgmode_expanded" 
	  ;;  :base-extension "org"
	  ...
	  ("cluster-engine-doc-sphinx-graphics"
	   :base-directory "./graphics/"
	   :base-extension "jpg\\|gif\\|png"
	   :publishing-directory "../doc_source_sphinx/graphics/"
	   :publishing-function org-publish-attachment)
	  ;; I tried to automatically call script to make sphinx project
	  ;; not working
	  ;; ("cluster-engine-make-sphinx-doc"
	  ;;  :base-directory "../doc_source_sphinx"
	  ;;  :publishing-directory "../doc_source_sphinx" ;; irrelevant, but necessary
	  ;;  :base-extension "sh"
	  ;;  :publishing-function ta/publish-sphinx-project)
	  ;; ("other"
	  ;;  :base-directory "~/other/"
	  ;;  :base-extension "css\\|el"
	  ;;  :publishing-directory "/ssh:user@host:~/html/other/"
	  ;;  :publishing-function org-publish-attachment)
	  ("cluster-engine-doc-sphinx"
	   :components ("cluster-engine-doc-sphinx-orgfiles" "cluster-engine-doc-sphinx-graphics" ; "cluster-engine-make-sphinx-doc"
			))

	  ("cluster-engine-doc-latex-orgfiles"
	   :base-directory "." ;; relative path
	   :base-extension "org"
	   :publishing-directory "../doc_source_latex"
	  ...
	  ("cluster-engine-doc-latex-graphics"
	   :base-directory "./graphics/"
	   :base-extension "jpg\\|gif\\|png\\|pdf"
	   :publishing-directory "../doc_source_latex/graphics/"
	   :publishing-function org-publish-attachment)
	  ("cluster-engine-doc-latex"
	   :components ("cluster-engine-doc-latex-orgfiles" "cluster-engine-doc-latex-graphics" ; "cluster-engine-make-sphinx-doc"
			))
	  ))

  (add-to-list 'org-latex-classes
	       '("cluster-engine-doc"
		 ;; empty header: no class, no default packages nor document-specific packages, but extras, just in case
		 "[NO-DEFAULT-PACKAGES]"
		 ("\\section{%s}" . "\\section*{%s}")
...
#+name: setup-lisp
#+begin_src lisp :results silent :exports none :cache yes
    ...
    ; (docparser::get-name 'cluster-engine:clusterengine docparser::doc-index)
    ...
    ; (docparser::get-docstring 'clusterengine docparser::doc-index)
    ...
    ; (docparser::get-lambda-list 'clusterengine docparser::doc-index)


    ; (docparser::get-lambda-list 'v docparser::doc-index)

    ; (docparser::get-lambda-list 'om:ambitus docparser::doc-index)
...
#+begin_src lisp :tangle yes :results raw    
(ce::clusterengine 
 10 t nil           ; settings
 nil                ; no constraints
 '((3 4))           ; metric domain
...
#+RESULTS:
((1/4 1/4 1/8 1/8 1/4 1/4 1/8 1/4 1/4 1/8) (60 60 60 61 60 61 60 60 60 61) ((3 4) (3 4) (3 4)))
...
* Test
  ...
  This is a test link to the documentation of function @@rst::ref:`R-RHYTHMS-ONE-VOICE`@@.
