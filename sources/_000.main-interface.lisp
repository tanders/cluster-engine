...
(defun Rules->Cluster   (&rest rules) ;;;; nil
  "Use this box to collect all rules before inputting them to the box/function @@rst:`clusterengine`_@@. It is possible to input the output of this box to a second Rules->Cluster box (to help organizing your rules in groups)."  
