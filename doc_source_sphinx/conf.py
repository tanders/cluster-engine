...
# -*- coding: utf-8 -*-
#
# cluster-engine documentation build configuration file, created by
...
# Python 2 StringIO is now io.StringIO
...
project = 'cluster-engine'
copyright = '2017, Örjan Sandred'
...
#     "project_nav_name": "Cluster Engine",
# }
...
htmlhelp_basename = 'cluster-enginedoc'
...
latex_documents = [
    (master_doc, 'cluster-engine.tex', 'cluster-engine Documentation',
     'Örjan Sandred', 'manual'),
]
...
man_pages = [
    (master_doc, 'cluster-engine', 'cluster-engine Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cluster-engine', 'cluster-engine Documentation',
     author, 'cluster-engine', 'One line description of project.',
     'Miscellaneous'),
]
